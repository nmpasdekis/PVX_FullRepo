#include <PVX_NeuralNets2.h>
#include "PVX_NeuralNets_Util.inl"

namespace PVX::DeepNeuralNets2 {
	...
	void NetContainer::Init() {
		switch (Type) {
			case PVX::DeepNeuralNets2::OutputType::MeanSquare:
				...
				break;
			case PVX::DeepNeuralNets2::OutputType::SoftMax:
				...
				break;
			case PVX::DeepNeuralNets2::OutputType::StableSoftMax:
